...
import net.is_bg.ltf.japplet.jzebra.exception.NullCommandException;
import net.is_bg.ltf.japplet.jzebra.exception.NullPrintServiceException;
...
public class PrintRaw {
    ...
    private final AtomicReference<String> jobName = new AtomicReference<String>("jZebra - Mateus Raw Printing");
