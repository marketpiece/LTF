...
/**
 * The Class ImopSelectStatement.
 */
public class ImopSelectStatement extends FileSelectStatement implements IFileWriteLibrary {    
	
    /**
     * Instantiates a new imop select statement.
     *
     ...
     */
    public ImopSelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.op("+ super.municipalityId +")";
	}
