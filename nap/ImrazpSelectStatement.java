...
/**
 * The Class ImrazpSelectStatement.
 */
public class ImrazpSelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new imrazp select statement.
	 *
	 ...
	 */
	public ImrazpSelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.rp("+ super.municipalityId +")";
	}
