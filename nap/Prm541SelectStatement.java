...
/**
 * The Class Prm541SelectStatement.
 */
public class Prm541SelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new prm541 select statement.
	 *
	 ...
	 */
	public Prm541SelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.p1("+ super.municipalityId +")";
	}
