...
/**
 * The Class Prm_SobSelectStatement.
 */
public class Prm_SobSelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new prm_ sob select statement.
	 *
	 ...
	 */
	public Prm_SobSelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.ps("+ super.municipalityId +")";
	}
