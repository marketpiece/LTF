...
/**
 * The Class ImzemSelectStatement.
 */
public class ImzemSelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new imzem select statement.
	 *
	 ...
	 */
	public ImzemSelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.zm("+ super.municipalityId +")";
	}
	    	...
	    	try {
			  w = createOutTextFile(super.filename, "Cp1251");
		       ...
		       /*FILLING THE FILE=============================================*/
		 	   while(rs.next()){ 
		 		 if (rs.getString(1) == null) {
		 			 System.out.print("Row "+rs.getRow()+" return null value");
		 		 }
