...
/**
 * The Class ImobektSelectStatement.
 */
public class ImobektSelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new imobekt select statement.
	 *
	 ...
	 */
	public ImobektSelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.ob("+ super.municipalityId +")";
	}
