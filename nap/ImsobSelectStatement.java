...
/**
 * The Class ImsobSelectStatement.
 */
public class ImsobSelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new imsob select statement.
	 *
	 ...
	 */
	public ImsobSelectStatement(String filename, long municipalityid, String header, NapFileHistory napFile) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.so("+ super.municipalityId +")";
		}
