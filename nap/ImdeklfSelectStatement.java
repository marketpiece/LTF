...
/**
 * The Class ImdeklfSelectStatement.
 */
public class ImdeklfSelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new imdeklf select statement.
	 *
	 ...
	 */
	public ImdeklfSelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.df17("+ super.municipalityId +")";
	}
