...
/**
 * The Class Imobef_ASelectStatement.
 */
public class Imobef_ASelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new imobef_ a select statement.
	 *
	 ...
	 */
	public Imobef_ASelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return  "select * from napdata.fa17("+ super.municipalityId +")";
	}
