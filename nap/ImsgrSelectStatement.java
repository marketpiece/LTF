...
/**
 * The Class ImsgrSelectStatement.
 */
public class ImsgrSelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new imsgr select statement.
	 *
	 ...
	 */
	public ImsgrSelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.sg("+ super.municipalityId +")";
	}
