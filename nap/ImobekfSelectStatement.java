...
/**
 * The Class ImobekfSelectStatement.
 */
public class ImobekfSelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new imobekf select statement.
	 *
	 ...
	 */
	public ImobekfSelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return  "select * from napdata.of17("+ super.municipalityId +")";
	}
