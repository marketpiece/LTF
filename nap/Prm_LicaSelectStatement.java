...
/**
 * The Class Prm_LicaSelectStatement.
 */
public class Prm_LicaSelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new prm_ lica select statement.
	 *
	 ...
	 */
	public Prm_LicaSelectStatement(String filename, long municipalityid, String header, NapFileHistory napData) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.pl("+ super.municipalityId +")";
	}
