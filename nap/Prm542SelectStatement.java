...
/**
 * The Class Prm542SelectStatement.
 */
public class Prm542SelectStatement extends FileSelectStatement implements IFileWriteLibrary {

	/**
	 * Instantiates a new prm542 select statement.
	 *
	 ...
	 */
	public Prm542SelectStatement(String filename, long municipalityid, String header, NapFileHistory napData ) {
	...
	protected String getSqlString() {
		...
		return "select * from napdata.p2("+ super.municipalityId +")";
	}
